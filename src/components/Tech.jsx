...
const Tech = () => {
  return (
    <motion.section
      id="tech"
      className="w-full flex flex-col justify-center items-center gap-10 pt-24 scroll-smooth"
    >
      <motion.div
      ...
      >
        <p className="bg-gradient-to-r from-blue-500 to-pink-500 bg-clip-text text-transparent text-2xl">
